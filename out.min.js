...
function getScore(t, e, n, o, r) {
    ...
    return Math.round(linterpol(r, [Math.pow(5, a), 1], [Math.pow(5, a + 1), 1])[0])
}! function(t, e, n) {
    function o(t, e) {
        return typeof t === e
    }
    ...
    Game = function() {
        function t(e, n, o, r) {
            ...
            _classCallCheck(this, t), this.config = window.config, this.width = o, this.web = !!r && window.innerHeight === window.innerWidth, this.realWidth = this.web ? 1024 : this.width, this.height = this.web ? 1024 : Math.floor(this.width * window.innerHeight / window.innerWidth), this.xOffset = Math.floor(this.realWidth - this.width) / 2, this.canvas = initCanvases(n, this.realWidth, this.height), this.target = [].concat(_toConsumableArray(this.canvas.entries())).reduce(function(t, e) {
                ...
                z: -1
            }).canvas, this.pausedTime = 0, this.timestamp = 0, this.overlay = 1, this.paused = 0, this.muted = 0, this._score = 0, this.state = function() {}, this.scene = new Scene, this.onPause = function() {}, this.onResume = function() {}, this.controller = gamee.controller.requestController(e), gamee.onPause = function() {
...
var _slicedToArray = function() {
    ...
    One23Game = function(t) {
        ...
        return _inherits(e, t), _createClass(e, [{
            ...
            key: "newGame",
            value: function() {
                this.overlay || gamee.gameStart(), this.score = 0, this.paused = 0, this.round = 0, this.scene.removeAllAnimations();
            ...
            value: function() {
                ...
                this.playSound("new", 0), this.equation = this.getEquation(), this.scene.addAnimation(function(t) {
                    console.log("TEEEEEEEEST" + e.equation[0])
            ...
            value: function(t, e) {
                ...
                if (this.scene.removeAllAnimations(), t === this.equation[1]) {
                    this.playSound("correct", 0), this.scene.addAnimation(function(t) {
                        ...
                        n.score += getScore(n.round, 5, 1.6, n.maxEquationLength - 2, e), console.log(n.score), n.round++, n.newRound()
                    }, this.now());
